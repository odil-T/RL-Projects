"""
TODO:
1. make a GUI play again feature
2. fix player collision
2. save to github 'reinforcement learning' repo subfolder of some sort. add readme, installation instructions
"""
import os.path
import pickle
import datetime
